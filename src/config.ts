...
const ConfigSchema = z.object({
  ...
  ecosystem: z.object({
    dapps: z.array(z.string()).default(["onmi-createToken", "zns-register", "lester-mint", "lester-create"]),
  }).default({ dapps: ["onmi-createToken", "zns-register", "lester-mint", "lester-create"] }),
  steps: z.object({
